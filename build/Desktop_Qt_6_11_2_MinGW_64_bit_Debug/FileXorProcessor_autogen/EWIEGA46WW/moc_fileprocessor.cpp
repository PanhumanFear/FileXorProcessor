...
void FileProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->fileProcessed((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 2: _t->processingFinished((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (FileProcessor::*)(int , const QString & )>(_a, &FileProcessor::progressUpdated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileProcessor::*)(const QString & , bool )>(_a, &FileProcessor::fileProcessed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileProcessor::*)(bool )>(_a, &FileProcessor::processingFinished, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (FileProcessor::*)(const QString & )>(_a, &FileProcessor::statusMessage, 3))
            return;
    }
}
...
// SIGNAL 2
void FileProcessor::processingFinished(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void FileProcessor::statusMessage(const QString & _t1)
{
